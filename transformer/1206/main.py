...
class VAE(nn.Module):
    def __init__(self, input_dim, hidden_dim, latent_dim, condition_dim, num_heads=4, num_layers=3, dropout_prob=0.2):
        ...
        self.fc_latent = nn.Linear(latent_dim+condition_dim, latent_dim)
        self.fc_mu_logvar = nn.Linear(latent_dim, latent_dim * 2)
