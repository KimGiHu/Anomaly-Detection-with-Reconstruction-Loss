...
bins = 100
# 히스토그램 그리기
plt.hist(mse[:sample], bins=bins_normal, alpha=0.5, label='Train',color='g')
plt.hist(mse_test[:sample], bins=bins_normal, alpha=0.5, label='Test',color='b')
plt.hist(mse_anomaly_0[:sample], bins=bins, alpha=0.5, label='0.001')
plt.hist(mse_anomaly_1st[:sample], bins=bins, alpha=0.5, label='0.01',color='r')
...
plt.hist(mse_anomaly_10th[:sample], bins=bins, alpha=0.5, label='0.10')
...
# 커널 밀도 추정 그래프 그리기
sns.kdeplot((mse[:sample]), fill=True, label='Train Dataset KDE', cut=0,color='g') # 학습한 데이터
sns.kdeplot((mse_test[:sample]), fill=True, label='Test Dataset KDE', cut=0,color='b') # 테스트 데이터
sns.kdeplot((mse_anomaly_1st[:sample]), fill=True, label='sigma 0.01 KDE', cut=0, color='r', common_norm=True) # 테스트 데이터
...
sns.kdeplot((mse_anomaly_10th[:sample]), fill=True, label='sigma 0.10 KDE', cut=0, common_norm=True) # 테스트 데이터
